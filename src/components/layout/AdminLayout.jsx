    ...
    <div className="admin-layout">
      ...
      <aside className={`admin-sidebar ${isSidebarOpen ? "sidebar-open" : ""}`}>
        <div className="sidebar-logo-container">
          ...
          >
            {/* Full wordmark — visible when sidebar is expanded */}
            <Logo
              variant="full"
              height={36}
              width={142}
              ...
              >
                ...
                <div className="profile-avatar">
                  ...
                  >
                    ...
                    <path
                      d="M12 18 C 12 12, 28 12, 28 18 C 28 16, 28 14, 25 13 C 22 12, 18 12, 15 13 C 12 14, 12 16, 12 18 Z"
                      fill="#7c2d12"
                    />
                    <circle cx="20" cy="20" r="7" fill="#ffedd5" />
                    <path
                      d="M16 18 Q18 17 19 18"
                      stroke="#7c2d12"
                      strokeWidth="1.2"
                      fill="none"
                    />
                    <path
                      d="M21 18 Q22 17 24 18"
                      stroke="#7c2d12"
                      strokeWidth="1.2"
                      fill="none"
                    />
              ...
              {isDropdownOpen && (
                <div className="profile-dropdown">
                  <button
                    ...
                    onClick={() => {
                      alert("Profile configuration is under development.");
                      setIsDropdownOpen(false);
                    }}
                  >
                    <FiUser size={16} />
